"""
Mock Data Generator - 模擬資料生成

Generates deterministic mock OHLCV price data for testing and development.
Used when API is unavailable or for reproducible testing.
"""
...
def get_mock_history(symbol: str, start_dt: datetime, end_dt: datetime) -> list:
